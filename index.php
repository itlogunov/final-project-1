...
<div class="wrapper">
    <div class="maincontent">
        ...
        <section class="section order">
            <div class="container">
                <div class="section__title" id="order-form-title">Закажите доставку</div>
                <div class="order__form">
                    <form class="order__form-tag" id="order-form">
                        <div class="order__form-col">
                            ...
                            <div class="order__form-row order__form-row_double">
                                <label class="order__form-block">
                                    <div class="order__form-label">E-mail*</div>
                            ...
                            <div class="order__form-row order__form-row_quatro">
                                <label class="order__form-block">
                                    ...
                                    <input class="order__form-input number-mask" name="home" type="text" placeholder="" required>
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Корпус</div>
                                    <input class="order__form-input number-mask" name="part" type="text" placeholder="">
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Квартира</div>
                                    <input class="order__form-input number-mask" name="appt" type="text" placeholder="">
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Этаж</div>
                                    <input class="order__form-input number-mask" name="floor" type="text" placeholder="">
                                </label>
                            </div>
                        </div>
                        <div class="order__form-col">
                            ...
                            <div class="order__form-buttons">
                                <div class="order__form-row">
                                    <label class="order__radio">
                                        <input class="order__radio-elem" name="payment" type="radio" value="Потребуется сдача">
                                        <div class="order__radio-fake"></div>
                                        <div class="order__radio-title">Потребуется сдача</div>
                                    </label>
                                    <label class="order__radio">
                                        <input class="order__radio-elem" name="payment" type="radio" value="Оплата по карте">
                                        <div class="order__radio-fake"></div>
